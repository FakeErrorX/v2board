...
class V2boardInstall extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            if (\File::exists(base_path() . '/.env')) {
                ...
                $this->info("Visit http(s)://yoursite/{$securePath} to enter the admin panel, you can modify your password in the user center.");
            ...
            $this->info("Visit http(s)://yoursite/{$defaultSecurePath} to enter the admin panel, you can modify your password in the user center.");
        } catch (\Exception $e) {
    ...
    private function registerAdmin($email, $password)
    {
        ...
        if (strlen($password) < 8) {
            abort(500, 'Administrator password must be at least 8 characters long');
        }
