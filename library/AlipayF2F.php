...
class AlipayF2F {
    ...
    public function send()
    {
        ...
        if (!isset($response[$resKey])) throw new \Exception('Failed to request from Alipay');
    ...
    private function buildSign(string $signData): string
    {
        ...
        //Encrypted content usually contains special characters and requires encoding conversion
