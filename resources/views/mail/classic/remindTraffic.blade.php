...
<head>
    <meta charset="UTF-8">
    <title>Traffic Notification</title>
    <style type="text/css">
        img {
            max-width: 100%;
        }
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr
                                        ...
                                        <td class="content-block"
                                            ...
                                            valign="top">
                                            Your monthly plan traffic has reached <strong>95%</strong> usage. Please manage your usage reasonably to avoid running out early.
                                        </td>
                                    </tr>
                                    <tr
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            ...
                            <tr
                                ...
                                <td class="aligncenter content-block"
                                    ...
                                    <a href="{{$url}}/#/knowledge"
                                        style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: none; margin: 0;">Tutorial</a>
                                </td>
                            </tr>
                        </table>
                    </div>
